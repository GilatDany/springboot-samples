package top.wjqian.week02.service;

import org.springframework.stereotype.Service;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;
import top.wjqian.week02.entity.Phone;
...
public class StudentService {
    ...
    static {
        Student student1= Student.builder().id(1001L).name("张三").gender("男").birthday(LocalDate.of(1990,1,1)).phone(Phone.builder().band("iphone").price(9999.99).color("black").build()).build();
